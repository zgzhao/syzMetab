...
#' @description Make metabolic graph from various type of data: keggPATH, ReactionSet, ReactionList, list, KOs or other xgraph object.
...
#' ## NOT RUN
#' library(gmetab)
#' pp <- make_mpath("ko00010", d.path="KEGG")
#' make_mgraph(pp)
